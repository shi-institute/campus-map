...
export { generateServiceDirectoryHeader } from './generateServiceDirectoryHeader.js';
export { generateServiceFiles } from './generateServiceFiles.js';
...
export { initDoc, jsonToArcGisHtml } from './jsonToArcGisHtml.js';
